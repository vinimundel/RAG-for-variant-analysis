...
assigned to exactly one layer by :mod:`healthrag.literature.corpus_layers`, with the
...
from healthrag.literature.corpus_layers import build_corpus_layers
from healthrag.literature.pubmed_records import fetch_records, load_cache
